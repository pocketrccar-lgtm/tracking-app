  ...
  return (
    <div className="px-4 pt-5 pb-28 space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-neutral-100">{product.name}</h1>
          ...
          <div className="mt-2 flex flex-wrap gap-1.5">
            ...
            <Badge variant="outline" className={product.inStock ? "bg-red-100 text-red-700" : "bg-slate-100 text-slate-500 dark:text-neutral-400"}>
      ...
      <div className="grid gap-3 sm:grid-cols-3">
        <Card>
          <CardContent className="p-4">
            <div className="text-xs uppercase tracking-wider text-slate-500 dark:text-neutral-400">Wholesale</div>
            <div className="mt-1 text-3xl font-bold font-mono text-slate-900 dark:text-neutral-100">
        ...
        <Card>
          <CardContent className="p-4">
            <div className="text-xs uppercase tracking-wider text-slate-500 dark:text-neutral-400">Retail</div>
            <div className="mt-1 text-3xl font-bold font-mono text-slate-900 dark:text-neutral-100">
        ...
        <Card>
          <CardContent className="p-4">
            <div className="text-xs uppercase tracking-wider text-slate-500 dark:text-neutral-400">MOQ</div>
            <div className="mt-1 text-3xl font-bold text-slate-900 dark:text-neutral-100">
              {product.moq ?? "—"}
            </div>
          </CardContent>
        </Card>
      ...
      {product.notes && (
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-slate-700 dark:text-neutral-300 whitespace-pre-line">{product.notes}</p>
          </CardContent>
        </Card>
      )}
      ...
      <Card>
        ...
        <CardContent>
          {product.priceHistory.length === 0 ? (
            <p className="text-sm text-slate-500 dark:text-neutral-400">No price changes recorded.</p>
          ) : (
            <Table>
              <TableHeader>
                <TableRow>
              ...
              <TableBody>
                {product.priceHistory.map((h) => (
                  <TableRow key={h.id}>
                    ...
                    <TableCell className="text-xs text-slate-500 dark:text-neutral-400">{h.recordedBy ?? "—"}</TableCell>
                    <TableCell className="text-xs text-slate-500 dark:text-neutral-400">{h.notes ?? ""}</TableCell>
                  </TableRow>
                ))}
              </TableBody>
            </Table>
